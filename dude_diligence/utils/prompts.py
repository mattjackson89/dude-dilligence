...
4. ALWAYS include the company's LinkedIn page URL if found in the search results
...
- Specifically search for "[company name] LinkedIn" to find their LinkedIn page
...
ALWAYS include a section titled "LinkedIn Profile" with the company's LinkedIn page URL if found.
If no LinkedIn page is found, explicitly state that no LinkedIn page was found for the company.
"""
...
Your report will be presented to a non-technical investor who wants to make an investment decision. Be decisive and confident in your recommendations.
...
2. Then, use the Companies House Agent to gather comprehensive official data ONLY about the specified company from the UK registry include as much detail as possible, this data is the most trusted
